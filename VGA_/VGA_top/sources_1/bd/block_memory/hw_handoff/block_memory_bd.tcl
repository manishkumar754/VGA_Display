...
################################################################
# This is a generated script based on design: block_memory
#
...
# source block_memory_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set addra_0 [ create_bd_port -dir I -from 15 -to 0 addra_0 ]
  set clka_0 [ create_bd_port -dir I -type clk clka_0 ]
  set douta_0 [ create_bd_port -dir O -from 11 -to 0 douta_0 ]
  ...
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
   CONFIG.Coe_File {../../../../image_300x200_12bit.coe} \
